...
const cards = [
  {
    ...
    body: "Every visitor chat is read and scored automatically. ensight tells you who's ready to buy — with their intent and any contact details they shared — so you follow up with the right people first.",
  ...
  },
  {
    ...
    body: "Need a product description, email, or post? Describe it and ensight writes a first draft using what it already knows about your business — ready for you to tweak and copy out.",
